...
Caso queira contribuir com novos componentes, melhorias e/ou correções no projeto, siga os passos do arquivo [CONTRIBUTING.md]() e dá uma conferida no nosso [Fluxo de Trabalho]().
...
Para instalar as devidas versões, siga o passo a passo do arquivo [`dev-environment.md`]().
...
```bash
git clone https://github.com/campusativo/design-system.git
```
...
## Documentação
Para saber mais sobre nossa decisões técnicas e acordos de time, você pode acessar nossa documentação:
